...
@section('content')
    <section class="admin-card">
        <form method="GET" class="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            <div>
            ...
            <div class="flex flex-wrap items-center gap-3 sm:col-span-2 xl:col-span-4 xl:justify-end">
    ...
    <section class="mt-6 grid items-start gap-6 xl:grid-cols-[minmax(0,1fr)_380px]">
